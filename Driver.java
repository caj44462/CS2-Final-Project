...
/**
 * Driver class creates a Mastermind object and allows for user interaction with
 * the game User will guess code until he/she wins or loses
 * 
 * @author cadejohnson
 * @version 12/10/19
 */
				...
				while (game.getGuessNumber() <= 10) {
					try {
						...
						for (int i = 0; i < game.getGuessList().size(); i++) {
							System.out.print(game.getGuessList().get(i) + " Black pegs: " + game.getBlackPegList().get(i)
